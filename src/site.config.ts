...
const config: SiteConfig = {
  ...
  description: 'Cursos de IoT: Fundamentos e implementación',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'José Bello', // Keywords for SEO, used in the meta tags.
  tags: ['IoT', 'Arduino', 'ESP32', 'ESP8266', 'IIoT'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/bellolongart',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/bellolongart',
    linkedin: 'https://www.linkedin.com/in/bellolongartj/',
    email: 'mailto:bellolongart@gmail.com',
  ...
  // Umcomment to enable github comments in the posts
  // giscus: {
